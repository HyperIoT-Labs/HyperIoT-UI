...
export class AssetTagsService {
     ...
     */
    public checkModuleWorking5(observe?: 'body', reportProgress?: boolean, context?: HttpContext): Observable<any>;
    public checkModuleWorking5(observe?: 'response', reportProgress?: boolean, context?: HttpContext): Observable<HttpResponse<any>>;
    public checkModuleWorking5(observe?: 'events', reportProgress?: boolean, context?: HttpContext): Observable<HttpEvent<any>>;
    public checkModuleWorking5(observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/assets/tags/module/status`,
            {
    ...
    public deleteAssetTag(id: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.basePath}/assets/tags/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAllAssetTag(observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/assets/tags/all`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAllAssetTagPaginated(delta?: number, page?: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/assets/tags`,
            {
    ...
    public findAssetTag(id: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/assets/tags/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getAssetTagResourceList(resourceName: string, resourceId: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/assets/tags/all/${encodeURIComponent(String(resourceName))}/${encodeURIComponent(String(resourceId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public saveAssetTag(body: AssetTag, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/assets/tags`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public updateAssetTag(body: AssetTag, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.basePath}/assets/tags`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
