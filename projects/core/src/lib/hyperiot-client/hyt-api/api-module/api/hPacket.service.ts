...
import { HPacketField } from '../model/hPacketField';
...
export class HPacketService {
    ...
    public addHPacketField(id: number, body: HPacketField, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/hpackets/${encodeURIComponent(String(id))}/fields`,
            body,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public checkModuleWorking12(observe?: 'body', reportProgress?: boolean, context?: HttpContext): Observable<any>;
    public checkModuleWorking12(observe?: 'response', reportProgress?: boolean, context?: HttpContext): Observable<HttpResponse<any>>;
    public checkModuleWorking12(observe?: 'events', reportProgress?: boolean, context?: HttpContext): Observable<HttpEvent<any>>;
    public checkModuleWorking12(observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/hpackets/module/status`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public deleteHPacket(id: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.basePath}/hpackets/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public deleteHPacketField(fieldId: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.basePath}/hpackets/fields/${encodeURIComponent(String(fieldId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAllHPacket(observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/hpackets/all`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAllHPacketByProjectId(id: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/hpackets/all/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAllHPacketByProjectIdAndType(id: number, types?: string, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/hpackets/all/${encodeURIComponent(String(id))}/types`,
            {
    ...
    public findAllHPacketPaginated(delta?: number, page?: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/hpackets`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public findHPacket(id: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/hpackets/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findTreeFields(id: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/hpackets/treefields/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getHDevicePacketList(id: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/hpackets/devices/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    /**
     * /hyperiot/hpackets/fields
     * Service for retrieving hpacket fields entity
     * @param fieldId list of packet fields the user wants to receive
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    ...
    public getHPacketField(fieldId: Array<number>, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        if (fieldId) {
            fieldId.forEach((element) => {
                queryParameters = queryParameters.append('fieldId', <any>element);
            })
        }
        ...
        return this.httpClient.get<any>(`${this.basePath}/hpackets/fields`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public saveHPacket(body: HPacket, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/hpackets`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public updateHPacket(body: HPacket, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.basePath}/hpackets`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public updateHPacketField(id: number, body: HPacketField, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.basePath}/hpackets/${encodeURIComponent(String(id))}/fields`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
