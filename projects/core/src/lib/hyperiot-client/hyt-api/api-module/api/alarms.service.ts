...
export class AlarmsService {
     ...
     */
    public checkModuleWorking1(observe?: 'body', reportProgress?: boolean, context?: HttpContext): Observable<any>;
    public checkModuleWorking1(observe?: 'response', reportProgress?: boolean, context?: HttpContext): Observable<HttpResponse<any>>;
    public checkModuleWorking1(observe?: 'events', reportProgress?: boolean, context?: HttpContext): Observable<HttpEvent<any>>;
    public checkModuleWorking1(observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/alarms/module/status`,
            {
    ...
    public deleteAlarm(id: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.basePath}/alarms/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAlarm(id: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/alarms/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAlarmStatusByProjectId(projectId: Array<number>, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/alarms/status`,
            {
    ...
    public findAllAlarm(observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/alarms/all`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAllAlarmByProjectId(projectId: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/alarms/all/projects/${encodeURIComponent(String(projectId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAllAlarmPaginated(delta?: number, page?: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/alarms`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public saveAlarm(body: Alarm, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/alarms`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public saveAlarmAndEvents(body?: Array<AlarmEvent>, alarmName?: string, isInhibited?: boolean, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/alarms/withEvents`,
            body,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
    ...
    public updateAlarm(body: Alarm, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.basePath}/alarms`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
