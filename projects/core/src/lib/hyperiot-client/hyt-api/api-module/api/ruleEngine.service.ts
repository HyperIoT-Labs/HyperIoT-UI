...
export class RuleEngineService {
     ...
     */
    public checkModuleWorking20(observe?: 'body', reportProgress?: boolean, context?: HttpContext): Observable<any>;
    public checkModuleWorking20(observe?: 'response', reportProgress?: boolean, context?: HttpContext): Observable<HttpResponse<any>>;
    public checkModuleWorking20(observe?: 'events', reportProgress?: boolean, context?: HttpContext): Observable<HttpEvent<any>>;
    public checkModuleWorking20(observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/rules/module/status`,
            {
    ...
    public deleteRule(id: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.basePath}/rules/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAllAvailableOperations(observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/rules/operations`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAllRule(observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/rules/all`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAllRuleActions(type?: string, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/rules/actions`,
            {
    ...
    public findAllRuleByPacketId(packetId: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/rules/bypacket/${encodeURIComponent(String(packetId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAllRuleByProjectId(projectId: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/rules/byproject/${encodeURIComponent(String(projectId))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public findAllRulePaginated(delta?: number, page?: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/rules`,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public findRule(id: number, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/rules/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public updateRule(body: Rule, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.basePath}/rules`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
