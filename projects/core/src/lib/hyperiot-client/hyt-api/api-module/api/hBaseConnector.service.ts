...
@Injectable()
export class HBaseConnectorService {
    ...
    /**
     * /hyperiot/hbase/connector/checkConnection
    ...
    public checkConnection(observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/hbase/connector/checkConnection`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public checkModuleWorking10(observe?: 'body', reportProgress?: boolean, context?: HttpContext): Observable<any>;
    public checkModuleWorking10(observe?: 'response', reportProgress?: boolean, context?: HttpContext): Observable<HttpResponse<any>>;
    public checkModuleWorking10(observe?: 'events', reportProgress?: boolean, context?: HttpContext): Observable<HttpEvent<any>>;
    public checkModuleWorking10(observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.get<any>(`${this.basePath}/hbase/connector/module/status`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    /**
     * /hyperiot/hbase/connector/tables
    ...
    public createTable(tableName?: string, columnFamilies?: string, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.post<any>(`${this.basePath}/hbase/connector/tables`,
    ...
    /**
     * /hyperiot/hbase/connector/tables/rows
    ...
    public deleteData(tableName?: string, rowKey?: string, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.basePath}/hbase/connector/tables/rows`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    /**
     * /hyperiot/hbase/connector/tables/{tableName}
    ...
    public dropTable(tableName: string, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.basePath}/hbase/connector/tables/${encodeURIComponent(String(tableName))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public enableTable(tableName: string, tableName2: boolean, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.basePath}/hbase/connector/tables/${encodeURIComponent(String(tableName))}`,
            null,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public insertData(tableName?: string, rowKey?: string, columnFamily?: string, column?: string, cellValue?: string, observe: any = 'body', reportProgress: boolean = false, context = new HttpContext()): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.basePath}/hbase/connector/tables`,
            convertFormParamsToString ? formParams.toString() : formParams,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
